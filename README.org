...
These snippets were translated using gpt-4o, and tested and tweaked by me.
...
If you're interested in contributing, here are the currently missing modes:
...
Also, see the previous section on known issues.
